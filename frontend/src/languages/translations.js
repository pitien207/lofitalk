...
const vietnamese = {
  ...
  sidebar: {
    ...
    fortune: {
      ...
      messages: [
        "Hôm nay là ngày dịu dàng để chia sẻ một điều nhỏ nhưng chân thành.",
        "Sự hiện diện bình yên của bạn đã thay đổi căn phòng rồi.",
        "Hãy nhắn cho một người bạn và xem câu chuyện trôi về đâu.",
        "Nhấp trà, chậm lại và để ý tưởng nở ra từ tốn.",
        "Có người biết ơn vì bạn tồn tại, dù họ quên nói ra.",
        "Đổi cho nhau một playlist ngắn có thể làm sáng buổi chiều của cả hai.",
        "Tin nhắn bạn cứ để đó chính là điều có thể làm mềm trái tim.",
        "Tối nay hãy dành cho nhật ký và ánh đèn vàng ấm.",
        "Hãy hỏi một câu thật tò mò; có thể nó sẽ mở ra cánh cửa mới.",
        "Hít năm hơi thật sâu trước khi trả lời và nhìn căng thẳng tan bớt.",
        "Tiếng cười của bạn là giai điệu mà ai đó đang cần nghe.",
        "Quay lại một sở thích cũ khoảng hai mươi phút để tìm lại sự bình yên.",
        "Một vòng đi bộ chậm có thể gỡ rối cả ngày hôm nay.",
        "Chia sẻ bức ảnh góc ấm áp của bạn; nó truyền cảm hứng cho sự bình yên.",
        "Uống nước trước khi đọc thông báo tiếp theo.",
        "Bộ não hai ngôn ngữ của bạn là cầu nối cho những câu chuyện mới.",
        ...
        "Sự tử tế của bạn vang xa hơn bạn nghĩ.",
        "Thắp một ngọn nến và để ánh sáng dẫn nhịp tập trung.",
        "Cuộc trò chuyện bạn đang lo lắng có lẽ sẽ dịu dàng hơn bạn tưởng.",
        "Trao đổi công thức nấu ăn, có thể bạn sẽ cùng trao đổi ký ức.",
        "Đọc một bài thơ thành tiếng cho chính mình tối nay.",
        "Tạm dừng việc lướt màn hình; sự yên lặng sẽ nạp lại bạn.",
        "Khen ai đó vì nỗ lực của họ, không chỉ vì kết quả.",
        "Quay về bản nhạc gợi nhớ buổi sáng để lấy lại cân bằng.",
        "Một lần vươn người sâu có thể giống như khởi động lại cả ngày.",
        "Chia sẻ một giấc mơ bạn từng thấy; biết đâu đó là gợi ý cho một dự án mới.",
        "Sự tò mò của bạn là chiếc la bàn đáng tin cậy.",
        "Gửi lời cảm ơn tới người có tin nhắn bạn từng lưu lại.",
        "Tưới cây và nghĩ về sự lớn lên của chính mình.",
        "Nhịp chậm của bạn vẫn là tiến bộ.",
        "Những câu trả lời chậm rãi thường là những câu trả lời chu đáo nhất.",
        "Cho người khác biết rằng một bài hát khiến bạn nhớ đến họ.",
        "Mở cửa sổ; không khí mới mang theo góc nhìn mới.",
        "Ăn mừng một chiến thắng nhỏ trước khi ngày kết thúc.",
        "Hãy nhớ nhờ giúp đỡ; đó là lời mời kết nối.",
        "Cười với một tấm meme ngớ ngẩn để thả nhẹ gánh nặng.",
        "Ghi lại một chi tiết ấm áp để sau này còn nhớ.",
        "Bạn có thể bắt đầu lại ngày hôm nay vào bất cứ giờ nào.",
        "Để ý ánh sáng trong phòng; nó đang cổ vũ bạn đó.",
        "Sự kiên nhẫn của bạn là món quà cho mọi cuộc trò chuyện.",
        "Mặc thứ gì đó mềm mại và để sự thoải mái dẫn đường.",
        "Thay việc doom scroll bằng năm phút vươn vai.",
        "Một ngụm trà có chánh niệm cũng là một chiến thắng.",
        "Nói chuyện dịu dàng với chính mình; bạn đang nghe rất rõ đấy.",
        "Kế hoạch yên tĩnh nhất đôi khi là cách hồi phục tốt nhất.",
        "Gửi lời động viên đi trước khi bạn cần được đáp lại.",
