...
const english = {
  ...
  sidebar: {
    ...
    fortune: {
      ...
      openedHint: "You already opened today's cookie. Come back tomorrow for another mindful note.",
...
const vietnamese = {
  ...
  sidebar: {
    ...
    fortune: {
      ...
      hint: "Chạm để bẻ đôi",
      openedHint: "Bạn đã mở bánh hôm nay rồi. Quay lại vào ngày mai để nhận lời nhắn mới nhé.",
...
const german = {
  ...
  sidebar: {
    ...
    fortune: {
      ...
      openedHint: "Du hast den Keks heute schon geöffnet. Komm morgen für eine neue Nachricht zurück.",
