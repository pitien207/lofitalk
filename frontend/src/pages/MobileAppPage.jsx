        ...
        <div className="mx-auto flex max-w-3xl flex-col gap-6 px-6 py-10">
          <section className="rounded-3xl border border-base-300 bg-base-100/80 p-8 shadow-xl text-center space-y-3">
            ...
            <p className="text-base text-base-content/70">
              Mobile app details will be available here soon.
            </p>
          </section>
        </div>
      </div>
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-6 py-10">
        <section className="rounded-3xl border border-base-300 bg-base-100/80 p-8 shadow-xl space-y-6">
          ...
          <div className="space-y-3">
            <h1 className="text-4xl font-bold text-base-content">
              {t("mobileAppPage.heroTitle")}
            </h1>
            <p className="text-base text-base-content/80">
              {t("mobileAppPage.heroSubtitle")}
            </p>
          </div>
