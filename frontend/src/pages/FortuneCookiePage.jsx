      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-6 py-10">
        <section className="rounded-3xl border border-base-300 bg-base-100/80 p-8 shadow-xl">
          <div className="space-y-3 text-center">
            ...
            <h1 className="text-4xl font-bold text-base-content">{t("sidebar.fortune.title")}</h1>
            <p className="text-base text-base-content/80">{t("sidebar.fortune.pageDescription")}</p>
          </div>
        </section>
